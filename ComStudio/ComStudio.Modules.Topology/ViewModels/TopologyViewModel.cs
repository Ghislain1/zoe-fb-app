namespace ComStudio.Modules.Topology.ViewModels
{
    ...
    public class TopologyViewModel : BindableBase
    {
        ...
        public TopologyViewModel(ITopologyService topologyService, IRegionManager regionManager, IEventAggregator eventAggregator)
        {
            ...
            this.HeaderInfo = "Web-Topology";

            this.address = "www.udemy.com";
        ...
        public string Address { get => this.address; set => this.SetProperty(ref this.address, value); }
        ...
        private void TopologyNodeListItems_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            {
                regionManager.Regions[RegionNames.MainRegion].RequestNavigate("/TopologyView", nr => { });
            }
        }
