...
namespace ComStudio.Infrastructure.Behaviors
{
    ...
    public abstract class DialogActivationBehavior : RegionBehavior, IHostAwareRegionBehavior
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="DependencyObject"/> that the <see cref="IRegion"/> is
        /// attached to.
        /// </summary>
        /// <value>
        /// A <see cref="DependencyObject"/> that the <see cref="IRegion"/> is attached to. This is
        /// usually a <see cref="FrameworkElement"/> that is part of the tree.
        /// </value>
        public DependencyObject HostControl { get; set; }

        /// <summary>
        /// Override this method to create an instance of the <see cref="IWindow"/> that will be
        /// shown when a view is activated.
        /// </summary>
        /// <returns>
        /// An instance of <see cref="IWindow"/> that will be shown when a view is activated on the
        /// target <see cref="IRegion"/>.
        /// </returns>
