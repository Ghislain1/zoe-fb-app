...
namespace ComStudio.ChartControls
{
    public class ContinuousAxisPanel : Panel
    {
        ...
        // Using a DependencyProperty as the backing store for YValues. This enables animation,
        // styling, binding, etc...
        ...
        // Using a DependencyProperty as the backing store for DataValues. This enables animation,
        // styling, binding, etc...
        ...
        // Using a DependencyProperty as the backing store for Axis2Panel. This enables animation,
        // styling, binding, etc...
        ...
        private double CalculateValueIncrement(Size size)
        {
            ...
            // Find an increment value that is in the set {1*10^x, 2*10^x, 5*10^x, where x is an
