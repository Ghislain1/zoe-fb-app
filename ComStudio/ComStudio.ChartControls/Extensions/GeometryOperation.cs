...
namespace ComStudio.ChartControls.Extensions
{
    public class GeometryOperation
    {
        ...
        /// <summary>
        /// Returns the flattened geometry for the argument vertex. It does not take the transforms
        /// on the vertex into account.
        /// </summary>
        /// <param name="v"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Builds a geometry group for the given visual taking into account the transform, clip and
        /// enumerating the drawings.
        /// </summary>
        ...
        /// <summary>
        /// Walks the children of a visual to build a geometry tree. Ignores the transform and clip
        /// on the visual.
        /// </summary>
        /// <param name="v"></param>
        /// <param name="g"></param>
